...
/**
 * Signals that the structure file specified was invalid.
 *
...
{
    private static final long serialVersionUID = -1867041601023153888L;

    InvalidStructureFileException(final String message)
    {
        super(message);
    }
}
